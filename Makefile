...
#    Updated: 2022/12/10 16:29:01 by nflan            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
INC =			$(addsuffix .hpp, $(addprefix $(INC_DIR), vector stack viterator tools iterator reverse_viterator rbtree rbiterator map))
