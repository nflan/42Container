...
#    Updated: 2022/12/12 18:33:14 by nflan            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
INC =			$(addsuffix .hpp, $(addprefix $(INC_DIR), vector stack viterator tools iterator reverse_viterator rbtree rbiterator reverse_rbiterator map))
